...
const confirmEmail = ((code)=>{
    let confirm = {
        ...
        html: `<div id=":161" class="ii gt" jslog="20277; u014N:xr6bB; 1:WyIjdGhyZWFkLWY6MTgwMzE5NzA2MTkwMjYzMzEwMCJd; 4:WyIjbXNnLWY6MTgwMzE5NzA2MTkwMjYzMzEwMCJd">
                        ...
                        <tbody>
                          <tr>
                            <td valign="top" style="padding:20px;text-align:left;color:#5f5f5f;font-size:14px;font-family:Helvetica,Arial,sans-serif;direction:ltr;box-sizing:border-box">
                              <p style="text-align:center;margin:0px;padding:0px;color:#616262;font-size:22px;font-family:Helvetica,Arial,sans-serif"><span style="color:#f10fff">Confirm your Cyclix Games email
                              </span></p>
                            </td>
                          </tr>
                        </tbody>
                    ...
                    <div class="m_4298953705539049861layer_2" style="max-width:600px;display:inline-block;vertical-align:top;width:100%">
                      <table style="border-collapse:collapse;width:100%" cellspacing="0" border="0">
                        <tbody>
                          <tr>
                            <td valign="top" style="padding:20px;text-align:left;color:#5f5f5f;font-size:14px;font-family:Helvetica,Arial,sans-serif;direction:ltr;box-sizing:border-box">
                              <p style="text-align:center;margin:0px;padding:0px"><span style="color:#b1b6c6">To confirm your Cyclix games email address, please copy the code below.<h2 style="color: rgb(6, 230, 6);
